      ...
      <div className="footer-inner">
        <div className="footer-grid">
          <div className="footer-brand">
            <div className="footer-logo">
              <div className="footer-logo-icon">PP</div>
              <span className="footer-logo-text">
                Pistas<span>Padel</span>
              </span>
            </div>
            <p className="footer-description">
              La plataforma líder en reserva de pistas de pádel. Conectamos
              jugadores con las mejores instalaciones deportivas.
            </p>
          ...
          <div>
            ...
            <div className="footer-links">
              <Link to="/pistas" className="footer-link">Pistas</Link>
              <Link to="/reservas" className="footer-link">Reservas</Link>
              <Link to="/tarifas" className="footer-link">Tarifas</Link>
          ...
          <div>
            <h3 className="footer-column-title">Ayuda</h3>
            <div className="footer-links">
        ...
        <div className="footer-bottom">
          <span className="footer-copyright">
            &copy; {new Date().getFullYear()} PistasPadel. Todos los derechos reservados.
          </span>
          <div className="footer-bottom-links">
            <Link to="/privacidad" className="footer-bottom-link">Privacidad</Link>
            <Link to="/cookies" className="footer-bottom-link">Cookies</Link>
            <Link to="/terminos" className="footer-bottom-link">Términos</Link>
          </div>
        </div>
      </div>
    </footer>
